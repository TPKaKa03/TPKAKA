 ...
 * @author ACER
 */
@WebServlet(name = "XuatProduct", urlPatterns = {"/xuatExcelAccountControl"})
public class XuatAccount extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        FileOutputStream file = new FileOutputStream("C:\\ExcelWebBanHang\\" + "san-pham" + Integer.toString(randomNum) + ".xlsx");
        ...
        for (Account pro : list) {
            ...
            cell0 = row.createCell(0);
            cell0.setCellValue(pro.getUserid());
            cell1 = row.createCell(1);
            cell1.setCellValue(pro.getPhone());
            cell2 = row.createCell(2);
            cell2.setCellValue(pro.getName());
            cell3 = row.createCell(3);
            cell3.setCellValue(pro.getDob());
            cell4 = row.createCell(4);
