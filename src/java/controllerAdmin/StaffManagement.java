    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       AdminDao dao = new AdminDao();
        ...
        if (txtSearch == null || txtSearch.isEmpty()) {
            list = dao.getUserbyPaging(index, 2,10);
        } else {
            int count = dao.getTotalAccountusebuysearch(2, txtSearch);
            ...
            list = dao.getUserbyPagingsearch(firstPart, 2, index);
        }

        if (list == null || dao.getTotalAccountusebuysearch(2,txtSearch)==0) {
            list = dao.getUserbyPaging(index, 2,10); // Sử dụng danh sách mặc định nếu list là null
        }
