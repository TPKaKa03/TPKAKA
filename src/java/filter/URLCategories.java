 ...
 * @author ACER
 */
@WebFilter(filterName="URLCategories", urlPatterns={"/shop.jsp"})
public class URLCategories implements Filter {
	...
	if (debug) log("URLCategories:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("URLCategories:DoAfterProcessing");
	...
	*/
     ...
     */
       public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        if (cateID != null && !cateID.isEmpty()) {
            ...
            ProductCategory p = dao.getCategoriesByCateId(cateID);
            
            if (p != null) {
                String a = convertToNonDiacritic( p.getCategoryname());
	...
	if (filterConfig != null) {
	    if (debug) { 
		log("URLCategories:Initializing filter");
	    }
	}
    }
	...
	if (filterConfig == null) return ("URLCategories()");
	StringBuffer sb = new StringBuffer("URLCategories(");
