...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:9999/orangeshop/home";
    public static String vnp_TmnCode = "A2L587VZ";
    public static String vnp_HashSecret = "PHUKIBFSLNQRPELSPENSSSMLOAEOSGXH";
