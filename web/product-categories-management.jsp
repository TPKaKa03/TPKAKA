          ...
          <div id="wrapper">
            <nav class="navbar navbar-default top-navbar" role="navigation">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="dashboard"><strong><i class="icon fa fa-plane"></i>SWP391-KSG5</strong></a>
                            ...
                            <div class="panel-body">
                                <div style="display: flex;">
                                    <div style="margin: 10px;">
                                        <form action="productcategoriesmanagement" method="POST">
                                            <input name="productCategoryName" type="text" placeholder="Enter Category name" required>
                                            <button type="submit" class="btn btn-primary"><i
                                                    class="fa fa-search"></i></button>
                                        </form>
                                    </div>
                                    <div style="margin: 10px;">
                                        <a href="productcategoryform"><button type="submit" class="btn btn-primary">Add Category</button></a>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <c:forEach items="${productCategories}" var="c">
                                                <tr class="gradeU">
                                                    ...
                                                    <td>
                                                        <a href="productcategoryform?id=${c.categoryid}"><button type="submit" class="btn btn-primary">Edit</button></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
