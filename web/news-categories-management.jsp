...
<html>
    ...
    <head>
        ...
        <title>News Category Management</title>
                            ...
                            <div class="panel-body">
                                <div style="display: flex;">
                                    <div style="margin: 10px;">
                                        <form action="newscategoriesmanagement" method="POST">
                                            <input name="newsCategoryName" type="text" placeholder="Enter Category name" required>
                                            <button type="submit" class="btn btn-primary"><i
                                                    class="fa fa-search"></i></button>
                                        </form>
                                    </div>
                                    <div style="margin: 10px;">
                                        <a href="newscategoryform"><button type="submit" class="btn btn-primary">Add Category</button></a>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <c:forEach items="${newsCategories}" var="c">
                                                <tr class="gradeU">
                                                    ...
                                                    <td>${c.name}</td>
                                                    <td>
                                                        <a href="newscategoryform?id=${c.id}"><button type="submit" class="btn btn-primary">Edit</button></a>
                                                    </td>
                                                    <td>
                                                        <form id="${c.id}" action="newscategorydelete">
                                                            <input type="text" name="deleteId" value="${c.id}" hidden/>
