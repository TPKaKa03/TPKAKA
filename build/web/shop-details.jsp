<%-- 
    ...
    Created on : Jan 10, 2024, 2:12:20 AM
    Author     : ADMIN
--%>
...
<html lang="zxx">
    ...
    <head>
        ...
        <title>${detail.product.name ne null ? detail.product.name : "Orange Cake"}</title>
        ...
        <style>
            /* Ẩn các button mũi tên tăng/giảm giá trị */
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product__details__img">
                            ...
                            <div class="product__details__big__img">
                                <img class="big_img" src="assets/img/shop/${detail.image.imglink}" alt="">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="product__details__text">
                            <form action="Cart?productid=${detail.product.productid}" method="POST">
                                <div class="product__label">${detail.category.categoryname}</div>

                                <h4>${detail.product.name}</h4>
                                <h5 class="formattedPrice">${detail.product.price}</h5>
                                <p>${detail.product.description}</p>

                                <div class="product__details__option">
                                    <div class="quantity">
                                        <div class="pro-qty">
                                            <input id="quantityInput" name="quantity" type="number" value="1" min="1" max="${detail.product.totalproduct}">
                                        </div>
                                        <div id="quantityError2" style="color: red; display: none;">Vượt quá số lượng bánh tại cửa hàng</div>
                                        <div id="quantityError1" style="color: red; display: none;">Hãy chọn lại số lượng bánh bạn muốn mua</div>
                                    </div>
                                    <button class="primary-btn" onclick="addToCart()" type="submit">Add to cart</button>
                    ...
                    <script>
                        function addToCart() {
                            ...
                            var min = 1;
                            var max = ${detail.product.totalproduct};
                            if (input < min) {
