                    ...
                    <div class="col-lg-5 col-md-8">
                        ...
                        <div class="card login-page bg-white shadow mt-4 rounded border-0">
                            <div class="card-body">
                                ...
                                <form action="register-phone" method="post" class="login-form mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">                                               
                                                ...
                                                <input type="text" class="form-control" placeholder="Họ và tên của bạn" name="fullname" value="${fullname}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <a href="register" class="text-dark h6 mb-0">Đăng ký với Email</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 mb-0">
                                            <div class="d-grid">
                                                <input type="button" class="btn btn-primary" ${success != 'Success' ? 'disabled':''} 
                                                       value="Đăng Ký" onClick="codeverify()">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 text-center">
                                            <p class="mb-0 mt-3"><small class="text-dark me-2">Bạn đã có tài khoản ?</small> <a href="login-phone" class="text-dark fw-bold">Đăng Nhập</a></p>
                                        </div>
                        ...
                        <script>
                            $(document).ready(function () {
                                ...
                                if (message !== '') {
                                    // Hiển thị toast
                                    toastr.success('Vui lòng nhấn gửi mã - nhập mã xác thực để đăng ký', 'Tên - Số điện thoại của bạn hợp lệ!', {
                                        timeOut: 4000,
        ...
        <script>
                            ...
                            function codeverify() {
                                ...
                                coderesult.confirm(code).then(function () {
                                    // Chuyển hướng đến trang register thành công và truyền thông tin số điện thoại, tên
                                    window.location.href = "succesful-registerphone?phone=${phone}&fullname=${fullname}";
                                    // Ẩn thông báo lỗi
