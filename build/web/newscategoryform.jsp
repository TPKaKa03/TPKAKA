...
<html>
    <head>
        ...
        <title>News Category Form</title>
                        ...
                        <div class="col-xs-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form action="newscategoryform" method="POST">
                                        <div class="sub-title">News Category Name <span style="color: red;">${verify == null ? "*" : verify}</span></div>
                                        <input name="newsCategoryName" class="form-control" value="${category.name}">
