            ...
            <div id="page-wrapper" >
                <div class="header"> 
                    <h1 class="page-header">
                        Product Category Form <small>For create and edit Product Category.</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#">Home</a></li>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="card-title">
                                        <h3><div class="title">${productCategory == null ? "Create" : "Edit"} Product Category</div></h3>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form action="productcategoryform" method="POST">
                                        <div class="sub-title">Product Category Name <span style="color: red;">${verify == null ? "*" : verify}</span></div>
                                        <input name="productCategoryName" class="form-control" value="${category.categoryname}">
                                        <div style="margin-top: 15px;">
                                            <input name="categoryId" value="${category.categoryid}" hidden>
